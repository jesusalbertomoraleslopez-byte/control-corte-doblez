...
def view_avances():
    ...
    # Mostrar historial de movimientos de esta área en la columna derecha
    with right_col:
        st.markdown(f"### 🕒 Últimos Registros ({area_seleccionada})")
        st.markdown("👇 *Hora y último registro primero*")
        ...
        if not df_movimientos.empty:
            ...
            st.dataframe(df_movimientos.head(15), use_container_width=True, hide_index=True, height=500)
        else:
            st.info("No hay movimientos registrados para esta área.")
